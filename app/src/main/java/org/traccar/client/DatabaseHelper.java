...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void insertPosition(Position position) {
        ...
        values.put("email", position.getEmail());
        ...
        values.put("emergency", position.getEmergency());
    ...
    public Position selectPosition() {
        ...
        try {
            if (cursor.getCount() > 0) {
                ...
                position.setEmail(cursor.getString(cursor.getColumnIndex("email")));
                ...
                position.setEmergency(cursor.getInt(cursor.getColumnIndex("emergency")) > 0);
